...
# run 'npm run buildDev'before this script to live sync changes

# https://docs.okd.io/latest/dev_guide/copy_files_to_container.html

pod_name=$(oc get pods --selector app=angular-app | { read line1 ; read line2 ; echo "$line2" ; } | awk '{print $1;}')
